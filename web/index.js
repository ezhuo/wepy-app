...
/***** module 0 start *****/
/***** src\pages\main\index.wpy *****/
function(module, exports, __wepy_require) {module.exports = "\n  <div class=\"page-index\">\n    <SearchBar  v-bind:placeholder.once=\"searchText\"></SearchBar>\n    <Swiper  v-bind:list.sync=\"swipers\" height=\"280\"></Swiper>\n    <Category v-bind:list.sync=\"categorys\" col=\"4\"></Category>\n    <IndexList v-bind:list.sync=\"list\" title=\"图书列表\" v-bind:loading.sync=\"loading\" v-bind:noMore.sync=\"noMoreList\"></IndexList>\n  </div>\n"},/***** module 0 end *****/


/***** module 1 start *****/
/***** src\pages\main\search.wpy *****/
function(module, exports, __wepy_require) {module.exports = "\n  <div class=\"main-search\">\n    <div v-if=\"(items1)\">\n      <checkboxButton1  v-bind:title.sync=\"title1\" v-bind:list.sync=\"items1\" v-bind:value.sync=\"value1\"></checkboxButton1>\n    </div>\n    <div v-if=\"(items2)\">\n      <checkboxButton2  v-bind:title.sync=\"title2\" v-bind:list.sync=\"items2\" v-bind:value.sync=\"value2\"></checkboxButton2>\n    </div>\n    <div v-if=\"(items3)\">\n      <checkboxButton3 v-bind:title.sync=\"title3\" v-bind:list.sync=\"items3\" v-bind:value.sync=\"value3\"></checkboxButton3>\n    </div>\n    <div v-if=\"(items4)\">\n      <checkboxButton4 v-bind:title.sync=\"title4\" v-bind:list.sync=\"items4\" v-bind:value.sync=\"value4\"></checkboxButton4>\n    </div>\n    <button @click=\"search($event)\" class=\"weui-btn\" type=\"primary\">搜索</button>\n  </div>\n"},/***** module 1 end *****/


/***** module 2 start *****/
/***** src\pages\main\list.wpy *****/
function(module, exports, __wepy_require) {module.exports = "\n  <div class=\"main-list\">\n    <div class=\"main-list-title clearfix\" v-if=\"(keywords &amp;&amp; keywords.length)\">\n      <div class=\"pull-left width-8p\">\n        <div v-for=\"(index, item) in (keywords)\">\n          <span v-if=\"(index > 0)\">，</span>\n          <span>{{item}}</span>\n        </div>\n      </div>\n      <span @click=\"clearSearch($event)\" class=\"link link-blue pull-right\">清空筛选</span>\n    </div>\n    <IndexList  v-bind:list.sync=\"list\" v-bind:loading.sync=\"loading\" v-bind:noMore.sync=\"noMoreList\"></IndexList>\n  </div>\n"},/***** module 2 end *****/


/***** module 3 start *****/
/***** src\pages\main\detail.wpy *****/
function(module, exports, __wepy_require) {module.exports = "\n  <div class=\"main-detail\">\n    <div class=\"weui-panel\">\n      <div v-if=\"(banners &amp;&amp; banners.length)\">\n        <div class=\"detail-cover\">\n          <Swiper  v-bind:list.sync=\"banners\" height=\"200\" v-bind:navigate.once=\"navigate\"></Swiper>\n        </div>\n      </div>\n      <div  wx:else=\"wx:else\">\n        <img class=\"detail-cover\" mode=\"aspectFit\" :src=\"(book.image || img_banner)\"/>\n      </div>\n      <div class=\"weui-media-box weui-media-box_text weui-cells_in-small-appmsg\">\n        <div class=\"h3 color-333\">{{book.name}}</div>\n        <div class=\"detail-info\">\n          <div>作者：{{book.author}}</div>\n          <div>出版社：{{book.pubcompany}}</div>\n          <div>出版时间：{{book.pubtime}}</div>\n        </div>\n        <div class=\"detail-tags\">\n          <span class=\"tag\" v-for=\"(index, tag) in (book.tags)\">{{tag}}</span>\n        </div>\n      </div>\n    </div>\n\n    <div class=\"weui-panel\">\n      <div class=\"weui-media-box weui-media-box_text\">\n        <div class=\"detail-desc-title\">简介：</div>\n        <div class=\"detail-desc\">\n          <div v-for=\"(index, desc) in (description)\">\n            <div class=\"detail-text\" v-if=\"(desc.type === 'text')\">{{desc.value}}</div>\n            <img class=\"detail-image\" mode=\"widthFix\" :wx:elif=\"(desc.type === 'image')\" :src=\"(desc.value || img_banner)\"/>\n          </div>\n        </div>\n      </div>\n    </div>\n\n    <Screen class=\"fixed-bottom\">\n      <div style=\"display: flex;\">\n        <button @click=\"toStar($event)\" class=\"weui-btn btn-block btn-flex-1\">\n          <div v-if=\"(isCollect)\">\n            <img class=\"imgicon\" mode=\"aspectFit\" :src=\"(icon_star_active)\"/>\n            <div class=\"btn-text-bottom color-999\">已收藏</div>\n          </div>\n          <div wx:else=\"wx:else\">\n            <img class=\"imgicon\" mode=\"aspectFit\" :src=\"(icon_star)\"/>\n            <div class=\"btn-text-bottom\">收藏</div>\n          </div>\n        </button>\n        <button @click=\"toBorrow($event)\" class=\"weui-btn btn-block btn-flex-1\">\n          <img class=\"imgicon\" mode=\"aspectFit\" :src=\"(icon_shelf)\"/>\n          <div class=\"btn-text-bottom\">书架</div>\n        </button>\n        <button @click=\"toAdd((book),$event)\" class=\"weui-btn btn-block btn-flex-full\" type=\"primary\" :disabled=\"(!isEnabled)\">\n          <span v-if=\"(!isEnabled)\">已借完</span>\n          <span :wx:elif=\"(book.exist)\">已添加，查看书架</span>\n          <span wx:else=\"wx:else\">借阅</span>\n        </button>\n      </div>\n      <button slot=\"placeholder\" class=\"weui-btn btn-block\" type=\"primary\">借阅</button>\n    </Screen>\n\n  </div>\n"},/***** module 3 end *****/


/***** module 4 start *****/
/***** src\pages\borrow\index.wpy *****/
function(module, exports, __wepy_require) {module.exports = "\n  <div class=\"page-borrow\" v-if=\"(canBorrow)\">\n    <div class=\"weui-panel borrow-list\">\n      <div class=\"weui-panel__hd\">\n        <span>本次最多可借</span>\n        <span class=\"color-red\">{{borrowCount}}本</span>\n        <span>，还可借</span>\n        <span class=\"color-red\">{{borrowTime}}次</span>\n        <span>。</span>\n      </div>\n      <div class=\"weui-panel__bd\">\n        <div v-for=\"(index, item) in (borrowList)\">\n          <div class=\"weui-media-box weui-media-box_text\">\n            <div v-if=\"(item.good)\">\n              <div class=\"icon-order-circle\">{{index+1}}</div>\n              <div class=\"borrow-name-wrapper\">\n                <div class=\"borrow-book-name\">{{item.good.name}}</div>\n              </div>\n              <div @click=\"remove((item.good),$event)\" class=\"icon-delete reset-pull-right\"></div>\n            </div>\n            <div  wx:else=\"wx:else\">\n              <div class=\"icon-order-empty\">{{index+1}}</div>\n              <div class=\"borrow-name-wrapper\">\n                <div class=\"borrow-book-name color-ddd\">空</div>\n              </div>\n              <div @click=\"goMain($event)\" class=\"link link-blue reset-pull-right\">去借书</div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n    <div class=\"weui-panel\">\n      <div class=\"weui-media-box weui-media-box_text borrow-address\">\n        <div class=\"weui-media-box__title h4 color-666\">收货地址</div>\n        <div class=\"weui-cell__bd h4\">\n          <textarea @input=\"typing(address,$event)\" class=\"weui-textarea\" placeholder=\"请填写收货地址\" auto-height=\"auto-height\" :value=\"(address)\"></textarea>\n        </div>\n        <div @click=\"chooseAddress($event)\" class=\"link link-red reset-pull-middle\" v-if=\"(showChooseAddress)\">\n          <img class=\"imgicon icon-location\" mode=\"aspectFit\" src=\"/images/icon/icon-location@2x.png\"/>\n        </div>\n      </div>\n      <div class=\"weui-cell weui-cell_input\">\n        <div class=\"weui-cell__hd\">\n          <div class=\"weui-label reset-label-left h4\">手机号码</div>\n        </div>\n        <div class=\"weui-cell__bd h4\">\n          <input @input=\"typing(phone,$event)\" class=\"weui-input\" placeholder=\"请填写收货人手机号码\" :value=\"(phone)\"/>\n        </div>\n      </div>\n      <div class=\"weui-cell weui-cell_input\">\n        <div class=\"weui-cell__hd\">\n          <div class=\"weui-label reset-label-left h4\">收货人</div>\n        </div>\n        <div class=\"weui-cell__bd h4\">\n          <input @input=\"typing(receiver,$event)\" class=\"weui-input\" placeholder=\"请填写收货人姓名\" :value=\"(receiver)\"/>\n        </div>\n      </div>\n    </div>\n    <button @click=\"borrow($event)\" class=\"weui-btn btn-primary\" type=\"primary\">确认</button>\n  </div>\n  <div  wx:else=\"wx:else\" class=\"text-center tip-page page-borrow-tip\">\n    <div v-if=\"(loaded)\">\n      <icon class=\"tip-icon\" type=\"cancel\" size=\"70\" color=\"#bbb\"></icon>\n      <div class=\"h4\">您还没有订阅，快去选择吧~</div>\n      <button @click=\"toSubscribe($event)\" class=\"weui-btn mini-btn\" type=\"primary\" size=\"mini\">立即订阅</button>\n    </div>\n  </div>\n"},/***** module 4 end *****/


/***** module 5 start *****/
/***** src\pages\borrow\subscribe.wpy *****/
function(module, exports, __wepy_require) {module.exports = "\n  <div class=\"borrow-subscribe\">\n\n    <div class=\"weui-cells weui-cells_after-title borrow-address\">\n      <div class=\"weui-cell block\">\n        <div class=\"weui-media-box__title h4 color-666\">订阅时长</div>\n        <div v-if=\"(list &amp;&amp; list.length > 0)\">\n          <radioCard  v-bind:list.sync=\"list\" v-bind:value.sync=\"value\" key=\"id\"></radioCard>\n        </div>\n      </div>\n      <div class=\"weui-cell reset-cell-block\">\n        <div class=\"weui-media-box__title h4 color-666\">绑定手机号</div>\n      </div>\n      <div>\n        <div class=\"weui-cell weui-cell_input\">\n          <div class=\"weui-cell__hd\">\n            <div class=\"weui-label reset-label-left\">+86</div>\n          </div>\n          <div class=\"weui-cell__bd h4\">\n            <input @input=\"typing(phone,$event)\" class=\"weui-input\" placeholder=\"请填写收货人手机号码\" :value=\"(phone)\"/>\n          </div>\n        </div>\n        <div class=\"weui-cell weui-cell_input reset-input\">\n          <div class=\"weui-cell__bd h4\">\n            <input @input=\"typing(code,$event)\" class=\"weui-input\" placeholder=\"请输入验证码\" :value=\"(code)\"/>\n          </div>\n          <div class=\"weui-cell__ft\">\n            <div class=\"weui-label reset-label-right\">\n              <button @click=\"verify($event)\" class=\"weui-btn mini-btn\" type=\"default\" size=\"mini\">{{btnText}}</button>\n            </div>\n          </div>\n        </div>\n      </div>\n      <div class=\"weui-cell weui-cell_link\">\n        <div class=\"weui-cell__bd color-666\">价格</div>\n        <div class=\"weui-cell__ft pull-right color-red\">\n          <span class=\"h2\">{{realPrice}}</span>\n          <span>元</span>\n        </div>\n      </div>\n    </div>\n\n    <div class=\"weui-cells__tips\">\n      <div class=\"color-666\">说明</div>\n      <div class=\"color-999\">1. 订阅后不可退订</div>\n      <div class=\"color-999\">2. 如果订阅过程中无书可借，可申请退款</div>\n    </div>\n\n    <button @click=\"pay($event)\" class=\"weui-btn btn-primary\" type=\"primary\">去支付</button>\n\n  </div>\n"},/***** module 5 end *****/


/***** module 6 start *****/
/***** src\pages\borrow\result.wpy *****/
function(module, exports, __wepy_require) {module.exports = "\n  <div class=\"borrow-result tip-page\">\n\n    <div v-if=\"(type == 0)\">\n      <icon class=\"tip-icon\" type=\"success\" size=\"70\" color=\"#049BFF\"></icon>\n      <div class=\"h3 color-blue\">借阅成功</div>\n      <div class=\"h4 color-999\">\n        <div>寻寻觅觅 冷冷清清 凄凄惨惨戚戚</div>\n        <div>乍暖还寒时候 最难将息</div>\n      </div>\n      <button @click=\"jump($event)\" class=\"weui-btn mini-btn\" type=\"default\" size=\"mini\">查看订单</button>\n    </div>\n    <div  wx:else=\"wx:else\">\n      <icon class=\"tip-icon\" type=\"warn\" size=\"70\"></icon>\n      <div class=\"h3 color-blue\">借阅失败</div>\n      <div class=\"h4 color-999\">\n        <div>{{message}}</div>\n      </div>\n      <button @click=\"back($event)\" class=\"weui-btn mini-btn\" type=\"primary\" size=\"mini\">{{buttonText}}</button>\n    </div>\n\n  </div>\n"},/***** module 6 end *****/


/***** module 7 start *****/
/***** src\pages\user\index.wpy *****/
function(module, exports, __wepy_require) {module.exports = "\n  <div class=\"page-user\">\n    <div class=\"weui-panel\">\n      <div class=\"weui-cells weui-cells_after-title\">\n        <div class=\"weui-cell\">\n          <div class=\"weui-cell__bd userinfo clearfix\">\n            <img class=\"userinfo-avatar\" background-size=\"cover\" :src=\"( userInfo.avatarUrl )\"/>\n            <div class=\"userinfo-info\">\n              <div class=\"userinfo-nickname\">{{ nickName }}</div>\n              <div class=\"userinfo-status\">{{identity.type}}</div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n    <div class=\"weui-panel\">\n      <div class=\"weui-cells weui-cells_after-title\">\n        <a url=\"/pages/user/subscribe\" class=\"weui-cell weui-cell_access\" hover-class=\"weui-cell_active\">\n          <div class=\"weui-cell__bd\">我的订阅</div>\n          <div class=\"weui-cell__ft weui-cell__ft_in-access\">\n            <span>还可借</span>\n            <span class=\"color-green\">{{packages.times}}</span>\n            <span>次</span>\n          </div>\n        </a>\n        <a url=\"/pages/user/borrow\" class=\"weui-cell weui-cell_access\" hover-class=\"weui-cell_active\">\n          <div class=\"weui-cell__bd\">我的借阅</div>\n          <div class=\"weui-cell__ft weui-cell__ft_in-access\">\n            <span class=\"color-green\">{{packages.status}}</span>\n          </div>\n        </a>\n        <a url=\"/pages/user/collect\" class=\"weui-cell weui-cell_access\" hover-class=\"weui-cell_active\">\n          <div class=\"weui-cell__bd\">收藏图书</div>\n          <div class=\"weui-cell__ft weui-cell__ft_in-access\">\n            <span class=\"color-green\">{{identity.collection || '0'}}</span>\n          </div>\n        </a>\n      </div>\n    </div>\n  </div>\n"},/***** module 7 end *****/


/***** module 8 start *****/
/***** src\pages\user\borrow.wpy *****/
function(module, exports, __wepy_require) {module.exports = "\n  <div class=\"user-borrow\">\n    <div v-if=\"(loading)\">\n      <div class=\"weui-loadmore\">\n        <div class=\"weui-loading\"></div>\n        <div class=\"weui-loadmore__tips\">正在加载</div>\n      </div>\n    </div>\n    <div :wx:elif=\"(list &amp;&amp; list.length > 0)\">\n      <div v-for=\"(index, item) in (list)\">\n        <div class=\"weui-panel\">\n          <div class=\"weui-panel__hd\">\n            <span>{{item.date || '借阅日期'}}</span>\n            <span class=\"pull-right\">\n              <div v-if=\"(item.status == 2)\">\n                <div v-if=\"(item.remain &lt; 0)\">\n                  <span>逾期 </span>\n                  <span class=\"color-red\">{{-item.remain}}</span>\n                  <span> 天未归还</span>\n                </div>\n                <div  wx:else=\"wx:else\">\n                  <span>还剩 </span>\n                  <span class=\"color-green\">{{item.remain}}</span>\n                  <span> 天需归还</span>\n                </div>\n              </div>\n              <span wx:else=\"wx:else\">{{item.statusText || '借阅状态'}}</span>\n            </span>\n          </div>\n          <div class=\"weui-panel__bd\">\n            <div class=\"weui-media-box weui-media-box_appmsg\">\n              <div class=\"weui-media-box__hd weui-media-box__hd_in-appmsg\">\n                <div v-for=\"(index, book) in (item.books)\">\n                  <img class=\"weui-media-box__thumb\" mode=\"aspectFit\" :src=\"(book.image)\"/>\n                </div>\n              </div>\n              <div class=\"weui-media-box__bd weui-media-box__bd_in-appmsg\">\n                <div v-for=\"(index, book) in (item.books)\">\n                  <div class=\"weui-media-box__desc\">{{index+1}}. {{book.title}}</div>\n                </div>\n              </div>\n            </div>\n          </div>\n          <div class=\"weui-panel__ft weui-cells\" v-if=\"(2 == item.status)\">\n            <div class=\"weui-cell\">\n              <button @click=\"goReturn((item.id || ''),$event)\" class=\"weui-btn mini-btn\" type=\"default\" size=\"mini\">立即还书</button>\n            </div>\n          </div>\n        </div>\n      </div>\n      <div class=\"weui-loadmore weui-loadmore_line weui-loadmore_dot\">\n        <div class=\"weui-loadmore__tips weui-loadmore__tips_in-line weui-loadmore__tips_in-dot\"></div>\n      </div>\n    </div>\n    <div wx:else=\"wx:else\">\n      <div class=\"weui-loadmore weui-loadmore_line\">\n        <div class=\"weui-loadmore__tips weui-loadmore__tips_in-line\">暂无数据</div>\n      </div>\n    </div>\n  </div>\n"},/***** module 8 end *****/


/***** module 9 start *****/
/***** src\pages\user\return.wpy *****/
function(module, exports, __wepy_require) {module.exports = "\n  <div class=\"user-return\">\n    <div class=\"weui-panel\">\n      <div class=\"weui-media-box weui-media-box_text\">\n        <div class=\"weui-media-box__title weui-media-box__title_in-text\">请将图书邮寄至：</div>\n        <div class=\"weui-media-box__desc\">{{address}}</div>\n      </div>\n    </div>\n    <div class=\"weui-panel\">\n      <div class=\"weui-cells weui-cells_after-title\">\n        <div class=\"weui-cell weui-cell_input\">\n          <div class=\"weui-cell__bd\">\n            <input @input=\"typing(co,$event)\" class=\"weui-input\" placeholder=\"请输入快递公司\" :value=\"(express_co)\"/>\n          </div>\n        </div>\n        <div class=\"weui-cell weui-cell_input\">\n          <div class=\"weui-cell__bd\">\n            <input @input=\"typing(id,$event)\" class=\"weui-input\" placeholder=\"请输入快递单号\" :value=\"(express_id)\"/>\n          </div>\n        </div>\n      </div>\n    </div>\n    <button @click=\"doReturn($event)\" class=\"weui-btn btn-primary\" type=\"primary\">确认还书</button>\n  </div>\n"},/***** module 9 end *****/


/***** module 10 start *****/
/***** src\pages\user\collect.wpy *****/
function(module, exports, __wepy_require) {module.exports = "\n  <div class=\"user-collect\" v-if=\"(list.length)\">\n    <IndexList  v-bind:list.sync=\"list\" v-bind:loading.sync=\"loading\" v-bind:noMore.sync=\"noMoreList\" type=\"collect\"></IndexList>\n  </div>\n  <div  wx:else=\"wx:else\" class=\"user-collect-tip tip-page\">\n    <div v-if=\"(loaded)\">\n      <img class=\"imgicon tip-icon\" mode=\"widthFix\" :src=\"(icon_star)\"/>\n      <div class=\"h4\">快去收藏您喜欢的图书吧！</div>\n      <button @click=\"toIndex($event)\" class=\"weui-btn mini-btn\" type=\"primary\" size=\"mini\">首页</button>\n    </div>\n    <div wx:else=\"wx:else\">\n      <span class=\"weui-loading\" v-if=\"(loading)\"></span>\n    </div>\n  </div>\n"},/***** module 10 end *****/


/***** module 11 start *****/
/***** src\pages\user\subscribe.wpy *****/
function(module, exports, __wepy_require) {module.exports = "\n  <div class=\"user-subscribe\">\n    <div class=\"subscribe-title\">我的订阅</div>\n    <div class=\"weui-flex subscribe-wrapper\">\n      <div v-for=\"(index, item) in (list)\">\n        <div class=\"weui-flex__item subscribe-item\">\n          <div class=\"color-666 item-title\">{{item.title}}</div>\n          <div class=\"color-bbb h5\">{{item.subtitle}}</div>\n        </div>\n      </div>\n    </div>\n    <button @click=\"change($event)\" class=\"weui-btn mini-btn\" type=\"primary\" size=\"mini\" v-if=\"(loaded &amp;&amp; isShowBtn)\">立即续订</button>\n  </div>\n"},/***** module 11 end *****/
...
var _wepy = __wepy_require(13);

var _wepy2 = _interopRequireDefault(_wepy);

__wepy_require(14);

var _intercept = __wepy_require(15);

var _wxService = __wepy_require(16);

var wxService = _interopRequireWildcard(_wxService);

var _helpers = __wepy_require(17);
...
var _default = function (_wepy$app) {
  ...
  function _default() {
    ...
    _this.config = {
      pages: ['pages/main/index', 'pages/main/search', 'pages/main/list', 'pages/main/detail', 'pages/borrow/index', 'pages/borrow/subscribe', 'pages/borrow/result', 'pages/user/index', 'pages/user/borrow', 'pages/user/return', 'pages/user/collect', 'pages/user/subscribe'],
      window: {
    ...
    _this.use('promisify');
    _this.intercept('request', _intercept.InterceptRequest.call(_this));
    return _this;
  }
  ...
  _createClass(_default, [{
    ...
    key: 'globalDataSet',
    value: function globalDataSet(name, obj) {
      // 校验: globalData
...
__wepy_require(13).default.$createApp(_default, {"routes":{"pages/main/index":18,"pages/main/search":27,"pages/main/list":30,"pages/main/detail":31,"pages/borrow/index":33,"pages/borrow/subscribe":34,"pages/borrow/result":36,"pages/user/index":37,"pages/user/borrow":38,"pages/user/return":39,"pages/user/collect":40,"pages/user/subscribe":41},"style":[26,29,67,68,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93],"components":{},"apis":{}});
...
var _app = __wepy_require(49);

var _app2 = _interopRequireDefault(_app);

var _page = __wepy_require(50);

var _page2 = _interopRequireDefault(_page);

var _component = __wepy_require(51);

var _component2 = _interopRequireDefault(_component);

var _event = __wepy_require(52);

var _event2 = _interopRequireDefault(_event);

var _base = __wepy_require(53);

var _base2 = _interopRequireDefault(_base);

var _util = __wepy_require(54);

var _util2 = _interopRequireDefault(_util);

var _mixin = __wepy_require(55);

var _mixin2 = _interopRequireDefault(_mixin);

var _wx = __wepy_require(56);
...
var g = __wepy_require(57);

// IOS 10.0.1 may cause IOS crash.
g.Promise = __wepy_require(58);
g.regeneratorRuntime = __wepy_require(59);
...
var _config2 = __wepy_require(20);
...
var Intercept = function () {
  ...
  _createClass(Intercept, [{
    ...
    value: function config(params) {
      ...
      var openid = this.globalData.loginData.openid;
      var tokenid = this.globalData.loginData.session_key;
      params.header = Object.assign(params.header, {
        'content-type': 'application/json'
      }, _config.setRequestHeader(params.data, tokenid, openid));
...
/***** module 16 start *****/
/***** src\core\wxService\wxService.js *****/
function(module, exports, __wepy_require) {'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getUserInfo = exports.login = exports.userLogin = exports.authorize = undefined;
...
var userLogin = exports.userLogin = function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(self) {
    var $auth, loginInfo;
...
var login = exports.login = function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(self) {
    var _login, res, loginData, userInfo;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 6:
            ...
            _context3.next = 10;
            return wxHttp.httpNoWait(self, 'GET', 'login', {
              code: _login.code
            });
          ...
          case 13:
            ...
            loginData = Object.assign(self.globalData.loginData, res.data.data, {
              code: _login.code
            });
            ...
            // 开始获取用户信息
            _context3.next = 21;
            return getUserInfo(self, loginData);
          ...
          case 26:
            return _context3.abrupt('return', Promise.reject(userInfo));
...
var getUserInfo = exports.getUserInfo = function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(self, loginData) {
    var userInfo, res;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 8:
            ...
            _context4.next = 12;
            return wxHttp.httpNoWait(self, 'POST', 'userInfo', {
              loginData: loginData,
          ...
          case 12:
            ...
            return _context4.abrupt('return', Object.assign({}, config.userInfo, userInfo.userInfo));
  ...
  return function getUserInfo(_x4, _x5) {
...
var _wxNotice = __wepy_require(60);

var wxNotice = _interopRequireWildcard(_wxNotice);

var _wxHttp = __wepy_require(61);

var wxHttp = _interopRequireWildcard(_wxHttp);

var _config = __wepy_require(20);

var config = _interopRequireWildcard(_config);

var _auth = __wepy_require(62);
...
var typeCheck = function typeCheck(o) {
  ...
  return s.match(/\[object (.*?)\]/)[1].toLowerCase().trim();
};

var isTypeCheck = function isTypeCheck(typeName, obj) {
  return typeName.toLowerCase().slice(2).trim() === typeCheck(obj);
};
...
var timeToDate = exports.timeToDate = function timeToDate(number, format) {
...
var _demo = __wepy_require(21);

var _swiper = __wepy_require(22);

var _swiper2 = _interopRequireDefault(_swiper);

var _searchbar = __wepy_require(23);

var _searchbar2 = _interopRequireDefault(_searchbar);

var _category = __wepy_require(24);

var _category2 = _interopRequireDefault(_category);

var _indexList = __wepy_require(25);
...
var pageIndex = function (_parentPage) {
  _inherits(pageIndex, _parentPage);
  ...
  function pageIndex() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = pageIndex.__proto__ || Object.getPrototypeOf(pageIndex)).call.apply(_ref, [this].concat(args))), _this), _this.config = {
      navigationBarTitleText: '首页',
      navigationBarTextStyle: 'white',
      navigationBarBackgroundColor: '#049BFF'
    }, _this.$repeat = {}, _this.$props = { "SearchBar": { "xmlns:v-bind": "", "v-bind:placeholder.once": "searchText" }, "Category": { "v-bind:list.sync": "categorys", "col": "4" }, "IndexList": { "v-bind:list.sync": "list", "title": "图书列表", "v-bind:loading.sync": "loading", "v-bind:noMore.sync": "noMoreList" }, "Swiper": { "v-bind:list.sync": "swipers", "height": "280" } }, _this.$events = {}, _this.components = {
      ...
      testtap: function testtap() {
        var _this2 = this;

        this.$alert.confirm('fdas').then(function () {
          _this2.$httpGet('https://www.baidu.com', { a: 1, b: 2 }).then(function (res) {
            console.log(res);
          });
        }).catch(function () {
          _this2.$notice.info('取消');
        });
      }
  ...
  _createClass(pageIndex, [{
    ...
    value: function initPageData() {
      ...
      this.categorys.map(function (cate, index) {
        var xnum = Math.min(Math.max(index, 1), 3);
        cate.url = '/pages/main/search?params=' + _this4.helpers.$json({
          value: [xnum, 4 - xnum].map(function (item) {
            return _this4.helpers.getString(item);
          }),
          index: index + 1,
          title: cate.title
        });
    ...
    value: function updateBookList(page) {
      ...
      this.loading = true;
      // 请求列表
      this.$httpPost(_config.service.list, {
        // 默认从0开始为第一页
        page: page,
        size: this.size
      }, function () {
        ...
        data = data.data || [];
        // 示例规则：最多20本
        if (_this5.list.length >= 20) {
          _this5.noMoreList = true;
          return;
        }

        // 请求到空列表后就认为没有更多了
        if (_this5.helpers.isArray(data) && data.length === 0) {
          _this5.noMoreList = true;
          return;
        }
        if (!_this5.page || +_this5.page === 0) {
          _this5.list = _this5.getBooks(data);
        } else {
          // 添加到列表中
          _this5.list = [].concat(_toConsumableArray(_this5.list), _toConsumableArray(_this5.getBooks(data)));
        }
        // 成功了就增加一页
        _this5.page += 1;
        _this5.$apply();
      }).catch(function () {
        _this5.$notice.info('加载失败！');
      });
    }
    ...
    value: function getBooks(data) {
      ...
      return this.helpers.getArray(data).map(function (book, index) {
        var xlen = len + index;
        // 拼接示例数据
        return {
          id: xlen,
...
var _index = __wepy_require(63);

var _index2 = _interopRequireDefault(_index);

var _case = __wepy_require(64);
...
var parentPage = function (_wepy$page) {
  _inherits(parentPage, _wepy$page);
  ...
  function parentPage() {
    ...
    _classCallCheck(this, parentPage);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = parentPage.__proto__ || Object.getPrototypeOf(parentPage)).call.apply(_ref, [this].concat(args))), _this), _this.mixins = [_index2.default, _case2.default], _temp), _possibleConstructorReturn(_this, _ret);
  }
...
exports.setRequestHeader = exports.httpCode = exports.http = exports.router = exports.define = exports.canton = exports.userInfo = exports.service = exports.api = exports.host = exports.app = undefined;

var _blueimpMd = __wepy_require(65);
...
var host = exports.host = 'http://localhost:8090/api/weixin/v1';
...
var setRequestHeader = exports.setRequestHeader = function setRequestHeader($data) {
  var $token = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  var $openid = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  ...
  try {
    ...
    var md5Src = headers.style + headers.token + rData + http.check;
    // check
    headers.validate = (0, _blueimpMd2.default)(md5Src);
...
/***** module 22 start *****/
/***** src\theme\components\swiper.wpy *****/
function(module, exports, __wepy_require) {'use strict';
...
var _component = __wepy_require(66);
...
var Swiper = function (_parentComponent) {
  _inherits(Swiper, _parentComponent);
  ...
  function Swiper() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Swiper.__proto__ || Object.getPrototypeOf(Swiper)).call.apply(_ref, [this].concat(args))), _this), _this.props = {
      ...
      style_height: function style_height() {
        var h = this.height;
        return this.helpers.isNumber(+h) ? h + 'rpx' : this.isMatchHeight(h) ? h : '240rpx';
      }
  ...
  _createClass(Swiper, [{
    ...
    value: function isMatchHeight(str) {
      return this.helpers.isString(str) ? /\d+(r?px|em)$/.test(str) : false;
    }
  }]);
...
/***** module 23 start *****/
/***** src\theme\components\searchbar.wpy *****/
function(module, exports, __wepy_require) {'use strict';
...
var SearchBar = function (_parentComponent) {
  _inherits(SearchBar, _parentComponent);
...
/***** module 24 start *****/
/***** src\theme\components\category.wpy *****/
function(module, exports, __wepy_require) {'use strict';
...
var Category = function (_parentComponent) {
  _inherits(Category, _parentComponent);
...
exports.default.template=__wepy_require(44);
},/***** module 24 end *****/


/***** module 25 start *****/
/***** src\theme\components\indexList.wpy *****/
function(module, exports, __wepy_require) {'use strict';
...
var indexlist = function (_parentComponent) {
  _inherits(indexlist, _parentComponent);
  ...
  function indexlist() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = indexlist.__proto__ || Object.getPrototypeOf(indexlist)).call.apply(_ref, [this].concat(args))), _this), _this.props = {
      list: {
        type: Object,
        default: []
      },
      ...
      toStar: function toStar(book, index) {
        ...
        this.$httpPost(_config.service.collect, {
          book_ids: [book.id],
          type: newType
        }).then(function (_ref2) {
          var data = _ref2.data;
          ...
          data = data.data;
          // 重置本书收藏状态
          if (_this2.helpers.isObject(_this2.list[index])) {
...
exports.default.template=__wepy_require(45);
},/***** module 25 end *****/
...
var _checkboxButton = __wepy_require(28);
...
var mainSearch = function (_parentPage) {
  _inherits(mainSearch, _parentPage);
  ...
  function mainSearch() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = mainSearch.__proto__ || Object.getPrototypeOf(mainSearch)).call.apply(_ref, [this].concat(args))), _this), _this.config = {
      ...
      search: function search() {
        ...
        [1, 2, 3, 4].map(function (i) {
          ...
          if (_this2[value] && _this2[key]) {
            params['' + _this2[key]] = _this2.helpers.isArray(_this2[value]) ? _this2[value] : [_this2[value]];
          }
          // 整理条件对应的文案信息
          if (_this2[items]) {
            var titleArr = _this2.helpers.getArray(_this2[items]).filter(function (item) {
              return _this2.helpers.getArray(params['' + _this2[key]]).indexOf(_this2.helpers.getString(item.value)) > -1;
            }).map(function (item) {
              return item.name;
            });
  ...
  _createClass(mainSearch, [{
    ...
    value: function onLoad(query) {
      var _helpers$$parse = this.helpers.$parse(query && query.params),
          index = _helpers$$parse.index,
          value = _helpers$$parse.value;

      if (index && value) {
        // 多选时，预置对应value为对应数组
        this['value' + index] = [].concat(_toConsumableArray(this.helpers.getArray(value, [this.helpers.getString(value, '1')])));
      }
    }
  }, {
    key: 'onReady',
    ...
    value: function initPageData() {
      ...
      // 获取tag列表
      this.$httpGet(_config.service.tags).then(function (_ref2) {
        var data = _ref2.data;
        ...
        //   ]
        // }]
        var arr = _this3.helpers.getArray(data);
            ...
            list: list && list.map(function (item, index) {
              return {
                ...
                checked: function () {
                  ...
                  return value && value.indexOf ? value.indexOf(_this3.helpers.getString(index + 1)) > -1 : false;
                }()
              };
            })
          };
...
/***** module 28 start *****/
/***** src\theme\components\checkboxButton.wpy *****/
function(module, exports, __wepy_require) {'use strict';
...
var checkboxButton = function (_parentComponent) {
  _inherits(checkboxButton, _parentComponent);
  ...
  function checkboxButton() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = checkboxButton.__proto__ || Object.getPrototypeOf(checkboxButton)).call.apply(_ref, [this].concat(args))), _this), _this.props = {
      list: {
        twoWay: true,
        type: Object,
        default: []
      ...
      style_width: function style_width() {
        var col = this.col;
        return this.getPercent(1 / this.helpers.getNumber(col, 4));
      },
      style_gutter: function style_gutter() {
        var gutter = this.gutter;
        return this.getGutter(this.helpers.getNumber(gutter, 16), this.unit);
      },
      style_gutter_edge: function style_gutter_edge() {
        var gutter = this.gutter;
        var col = this.helpers.getNumber(this.col, 4);
        var edge = (col - 1) * this.helpers.getNumber(gutter, 16) / col;
  ...
  _createClass(checkboxButton, [{
    ...
    value: function initCheckBox() {
      // 初始化已选项
      var value = this.helpers.getString(this.value);
      for (var i = 0; i < this.list.length; i++) {
    ...
    value: function isValueEqual(a, b) {
      return this.helpers.getArray(a).indexOf(this.helpers.getString(b)) > -1;
    }
  }, {
    key: 'getPercent',
    value: function getPercent(num) {
...
exports.default.template=__wepy_require(46);
},/***** module 28 end *****/


/***** module 29 start *****/
/***** src\pages\main\search.wpy *****/
function(module, exports, __wepy_require) {module.exports = "body {\n  background: #fff;\n}\n.main-search {\n  position: relative;\n  padding: 14px 15px 10px;\n}\n\n"},/***** module 29 end *****/
...
var mainList = function (_parentPage) {
  _inherits(mainList, _parentPage);
  ...
  function mainList() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = mainList.__proto__ || Object.getPrototypeOf(mainList)).call.apply(_ref, [this].concat(args))), _this), _this.config = {
      ...
      keywords: function keywords() {
        ...
        var keywords = this.helpers.getString(words || title).split(/\s+/g);
        return keywords.filter(function (item) {
          return item;
        }) || [];
      }
    }, _this.$repeat = {}, _this.$props = { "IndexList": { "xmlns:v-bind": "", "v-bind:list.sync": "list", "v-bind:loading.sync": "loading", "v-bind:noMore.sync": "noMoreList" } }, _this.$events = {}, _this.components = {
      IndexList: _indexList2.default
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(mainList, [{
    ...
    value: function updateBookList(page) {
      ...
      this.$httpPost(_config.service.list, Object.assign({}, this.helpers.getObject(this.params), {
        // 默认从0开始为第一页
        page: page,
        size: this.size
      }), function () {
        ...
        // 请求到空列表后就认为没有更多了
        if (_this3.helpers.isArray(data) && data.length === 0) {
          _this3.noMoreList = true;
        }
...
var mainDetail = function (_parentPage) {
  _inherits(mainDetail, _parentPage);
  ...
  function mainDetail() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = mainDetail.__proto__ || Object.getPrototypeOf(mainDetail)).call.apply(_ref, [this].concat(args))), _this), _this.config = {
      ...
      banners: function banners() {
        return this.helpers.getArray(this.book && this.book.images);
      },
      ...
      toAdd: function toAdd(book) {
        ...
        this.addCart.call(this, {
          ...
          var exist = _this2.helpers.getObject(_this2.book).exist;
          // 匹配加车状态
          switch (+code) {
            case 0:
              {
            ...
            default:
              {
                // 加车失败，提示
                var msg = message || '暂时无法借阅';
                _this2.$alert.info(msg, '异常提示');
              }
          }
        });
      }
  ...
  _createClass(mainDetail, [{
    ...
    value: function onLoad(query) {
      ...
      setTimeout(function () {
        _this3.book = Object.assign({}, _this3.book, {
          id: _this3.helpers.getString(id) || _this3.book.id,
          name: title || '假如生活欺骗了你',
          author: author || '普希金',
    ...
    value: function getDetail() {
      ...
      // 获取书架状态，优化本页交互
      var ids = this.getCartList.call(this).filter(function (_ref3) {
        var good = _ref3.good;
        return good;
      }).map(function (_ref4) {
        var good = _ref4.good;
        return _this4.helpers.getString(good.id);
      });
      // 标识本商品已存在书架中
      if (ids.indexOf(this.helpers.getString(this.book.id)) > -1) {
        this.book.exist = 1;
      }
      // 切换展示库存: 0/1
...
/***** module 32 start *****/
/***** src\theme\components\screen.wpy *****/
function(module, exports, __wepy_require) {'use strict';
...
var Screen = function (_parentComponent) {
  _inherits(Screen, _parentComponent);
  ...
  function Screen() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Screen.__proto__ || Object.getPrototypeOf(Screen)).call.apply(_ref, [this].concat(args))), _this), _this.props = {
      position: {
        type: String,
        default: 'bottom'
      }
...
exports.default.template=__wepy_require(47);
},/***** module 32 end *****/
...
var pageBorrow = function (_parentPage) {
  _inherits(pageBorrow, _parentPage);
  ...
  function pageBorrow() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = pageBorrow.__proto__ || Object.getPrototypeOf(pageBorrow)).call.apply(_ref, [this].concat(args))), _this), _this.config = {
      ...
      borrow: function borrow() {
        ...
        setTimeout(function () {
          ...
          wx.navigateTo({
            // type: 成功 = 0，失败 > 0，
            url: '/pages/borrow/result?type=' + _this2.helpers.getNumber(res.code) + '&message=' + res.message
          });
        }, 200);
      },
      ...
      remove: function remove(item) {
        ...
        this.removeCart.call(this, item, function () {
  ...
  _createClass(pageBorrow, [{
    ...
    value: function initPageData() {
      ...
      function userBuild(_ref2) {
        ...
        this.phone = this.helpers.getString(this.phone || identity.mobile, '手机号码');
        this.address = this.helpers.getString(this.address || identity.address, '地址');
        this.receiver = this.helpers.getString(this.receiver || nickName, '用户');
        this.borrowTime = this.helpers.getNumber(this.borrowTime || packages.times, 1);
        this.borrowCount = this.helpers.getNumber(this.borrowCount || packages.quantity, 5);
    ...
    value: function updateBorrowList() {
      ...
      if (!this.helpers.getNumber(this.borrowCount)) return;

      // 获取购物车信息
      this.getCartList.call(this, function (list) {
        var realist = _this5.helpers.getArray(list, []);
        var lenList = [];
        for (var i = 0; i < +_this5.borrowCount; i++) {
          lenList.push(realist[i] || {});
        }
        _this5.borrowList = lenList;
      });
    }
  }]);
...
var _radioCard = __wepy_require(35);
...
var borrowSubscribe = function (_parentPage) {
  _inherits(borrowSubscribe, _parentPage);
  ...
  function borrowSubscribe() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = borrowSubscribe.__proto__ || Object.getPrototypeOf(borrowSubscribe)).call.apply(_ref, [this].concat(args))), _this), _this.config = {
      ...
      listIndex: function listIndex() {
        ...
        var arr = this.helpers.getArray((this.list || []).filter(function (item, index) {
          item.TEMPINDEX = index;
          return _this2.helpers.getString(_this2.value) === _this2.helpers.getString(item.id);
        }));
      ...
      pay: function pay() {
        ...
        function userBuild(result) {
          // 获取微信登录code，再提交套餐订单
          var code = result.loginData.code;
  ...
  _createClass(borrowSubscribe, [{
    ...
    value: function initPageData() {
      ...
      // ===== 以下随机示例 =====
      setTimeout(function () {
        _this3.list = _this3.helpers.getArray(_demo.packages);
        ...
        function userBuild(result) {
          ...
          this.phone = this.helpers.getString(this.helpers.getObject(user.identity).mobile);
        }
      }, 200);
    }
  }, {
    ...
    value: function requestPayment(data) {
      ...
      // ===================== 以下为success随机示例 =====================
      setTimeout(function () {
        var params = _this4.helpers.getObject({
          timeStamp: '',
          nonceStr: '',
          package: '',
          signType: '',
        ...
        wx.requestPayment(Object.assign({}, params, {
          ...
          fail: function fail(res) {
            wx.showModal({
              ...
              success: function success(res) {
                // ============ 假装支付成功:需要更新状态 ============
                _this4.$parent.globalDataSet('user', {
                  packages: {
                    times: _this4.list[_this4.listIndex].times,
                    remain: _this4.list[_this4.listIndex].times,
                    quantity: _this4.list[_this4.listIndex].quantity,
                    status: '未借阅'
                  }
                });
                wx.navigateBack();
...
exports.default = borrowSubscribe;
...
/***** module 35 start *****/
/***** src\theme\components\radioCard.wpy *****/
function(module, exports, __wepy_require) {'use strict';
...
var radioCard = function (_parentComponent) {
  _inherits(radioCard, _parentComponent);
  ...
  function radioCard() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = radioCard.__proto__ || Object.getPrototypeOf(radioCard)).call.apply(_ref, [this].concat(args))), _this), _this.props = {
      list: {
        twoWay: true,
        type: Object,
        default: []
  ...
  _createClass(radioCard, [{
    ...
    key: 'isValueEqual',
    value: function isValueEqual(a, b) {
      return this.helpers.getString(a) === this.helpers.getString(b);
    }
  }]);
...
var borrowResult = function (_parentPage) {
  _inherits(borrowResult, _parentPage);
  ...
  function borrowResult() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = borrowResult.__proto__ || Object.getPrototypeOf(borrowResult)).call.apply(_ref, [this].concat(args))), _this), _this.config = {
  ...
  _createClass(borrowResult, [{
    ...
    value: function onLoad(query) {
      ...
      this.type = this.helpers.getNumber(type);
...
var pageUser = function (_parentPage) {
  _inherits(pageUser, _parentPage);
  ...
  function pageUser() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = pageUser.__proto__ || Object.getPrototypeOf(pageUser)).call.apply(_ref, [this].concat(args))), _this), _this.config = {
      ...
      packages: function packages() {
        return this.helpers.getObject(this.helpers.getObject(this.userInfo).packages);
      },
      identity: function identity() {
        return this.helpers.getObject(this.helpers.getObject(this.userInfo).identity);
      },
      nickName: function nickName() {
        var info = this.helpers.getObject(this.userInfo);
        // 名称或头像不为空的，才认为是授权用户
  ...
  _createClass(pageUser, [{
    ...
    value: function onShow() {
      ...
      function userBuild(result) {
        ...
        var uinfo = this.helpers.getObject(info);
        var userInfo = this.helpers.getObject(this.userInfo);
...
var userBorrow = function (_parentPage) {
  _inherits(userBorrow, _parentPage);
  ...
  function userBorrow() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = userBorrow.__proto__ || Object.getPrototypeOf(userBorrow)).call.apply(_ref, [this].concat(args))), _this), _this.config = {
      ...
      goReturn: function goReturn(id) {
        var str = this.helpers.getString(id);
  ...
  _createClass(userBorrow, [{
    ...
    value: function initPageData() {
      ...
      // =============== 随机示例 ===============
      this.$httpPost(_config.service.list).then(function (_ref2) {
        var data = _ref2.data;

        data = data.data;
        _this2.getBorrow(_this2.helpers.getArray(data));
      }).catch(function (_ref3) {
        var data = _ref3.data;
...
var userReturn = function (_parentPage) {
  _inherits(userReturn, _parentPage);
  ...
  function userReturn() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = userReturn.__proto__ || Object.getPrototypeOf(userReturn)).call.apply(_ref, [this].concat(args))), _this), _this.config = {
      ...
      doReturn: function doReturn() {
        if (!this.helpers.getString(this.express_co)) {
          return this.$alert.info('请输入快递公司');
        }
        if (!this.helpers.getString(this.express_id)) {
          return this.$alert.info('请输入快递单号');
        }
      ...
      typing: function typing(type, e) {
        ...
        if (this.helpers.isDefined(this[key])) {
  ...
  _createClass(userReturn, [{
    key: 'onLoad',
    value: function onLoad(query) {
      this.id = this.helpers.getString(query && +query.id);
    }
  }, {
    key: 'onReady',
    value: function onReady() {
...
var userCollect = function (_parentPage) {
  _inherits(userCollect, _parentPage);
  ...
  function userCollect() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = userCollect.__proto__ || Object.getPrototypeOf(userCollect)).call.apply(_ref, [this].concat(args))), _this), _this.config = {
    ...
    }, _this.$repeat = {}, _this.$props = { "IndexList": { "xmlns:v-bind": "", "v-bind:list.sync": "list", "v-bind:loading.sync": "loading", "v-bind:noMore.sync": "noMoreList", "type": "collect" } }, _this.$events = {}, _this.components = {
      IndexList: _indexList2.default
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }
...
var userSubscribe = function (_parentPage) {
  _inherits(userSubscribe, _parentPage);
  ...
  function userSubscribe() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = userSubscribe.__proto__ || Object.getPrototypeOf(userSubscribe)).call.apply(_ref, [this].concat(args))), _this), _this.config = {
      ...
      isShowBtn: function isShowBtn() {
        ...
        return !this.list.reduce(function (pre, post) {
          return (_this2.helpers.isObject(pre) ? pre.value : pre) && !!post.value;
        });
      }
    }, _this.methods = {
  ...
  _createClass(userSubscribe, [{
    ...
    value: function initPageData() {
      ...
      function userBuild(result) {
        ...
        var list = this.helpers.getArray(this.list);
        list.map(function (obj) {
          var item = _this3.helpers.getObject(obj);
          var unit = _this3.helpers.getString(item.unit);
          var value = _this3.helpers.getNumber(packages[item.key], null);
...
/***** module 42 start *****/
/***** src\theme\components\swiper.wpy *****/
function(module, exports, __wepy_require) {module.exports = "\n  <swiper class=\"swiper\" :style=\"'height:' + (style_height)\" :autoplay=\"(autoplay)\" :indicator-dots=\"(indicatorDots)\" :indicator-color=\"(indicatorColor)\" :indicator-active-color=\"(indicatorActiveColor)\">\n    <div v-for=\"(index, item) in (list)\">\n      <swiper-item>\n        <a v-if=\"(item.url)\" :url=\"(item.url)\">\n          <img class=\"swiper-image\" mode=\"widthFix\" :src=\"(item.image)\" :style=\"'height:' + (style_height)\"/>\n        </a>\n        <div  wx:else=\"wx:else\" :style=\"'height:' + (style_height)\">\n          <img class=\"swiper-image\" mode=\"aspectFit\" :src=\"(item.image)\" :style=\"'height:' + (style_height)\"/>\n        </div>\n      </swiper-item>\n    </div>\n  </swiper>\n"},/***** module 42 end *****/


/***** module 43 start *****/
/***** src\theme\components\searchbar.wpy *****/
function(module, exports, __wepy_require) {module.exports = "\n  <div class=\"weui-search-bar search-view\" :style=\"'background:' + ( scrollTop === 0 ?'-webkit-linear-gradient(top, rgba(105,195,170, 1), rgba(105,195,170, 0.3))' :( scrollTop&lt;200 ? 'rgba(105,195,170,'+(scrollTop/400+0.3) +')' : 'rgba(105,195,170,1)')  ) + ' '\">\n    <div class=\"weui-search-bar__form\">\n      <div class=\"weui-search-bar__box\">\n        <icon class=\"weui-icon-search_in-box\" type=\"search\" size=\"14\"></icon>\n        <input type=\"text\" class=\"weui-search-bar__input\" @input=\"inputTyping($event)\" @blur=\"showInput(false,$event)\" confirm-type=\"search\" @confirm=\"search($event)\" :placeholder=\"(placeholder)\" :value=\"(inputVal)\" :focus=\"(inputShowed)\"/>\n        <div v-if=\"(inputVal.length > 0)\">\n          <div class=\"weui-icon-clear\" @click=\"clearInput($event)\">\n            <icon type=\"clear\" size=\"14\"></icon>\n          </div>\n        </div>\n      </div>\n      <label class=\"weui-search-bar__label\" @click=\"showInput(true,$event)\" v-show=\"!((inputShowed))\">\n        <icon class=\"weui-icon-search\" type=\"search\" size=\"14\"></icon>\n        <div class=\"weui-search-bar__text\">{{computedPlaceholder}}</div>\n      </label>\n    </div>\n    <div class=\"weui-search-bar__cancel-btn\" @click=\"search($event)\" v-show=\"!((!inputShowed))\">搜索</div>\n  </div>\n"},/***** module 43 end *****/


/***** module 44 start *****/
/***** src\theme\components\category.wpy *****/
function(module, exports, __wepy_require) {module.exports = "\n  <div class=\"category clearfix\">\n    <div v-for=\"(index, item) in (list)\">\n\n      <a class=\"category-item\" v-if=\"(item.url)\" :url=\"(item.url)\" :style=\"'width:' + (style_width)\">\n        <div class=\"category-icon-wrapper\">\n          <img class=\"category-icon\" mode=\"aspectFit\" :src=\"(item.image)\"/>\n        </div>\n        <div class=\"category-text\">{{item.title}}</div>\n      </a>\n      <div  wx:else=\"wx:else\" class=\"category-item\" :style=\"'width:' + (style_width)\">\n        <div class=\"category-icon-wrapper\">\n          <img class=\"category-icon\" mode=\"aspectFit\" :src=\"(item.image)\"/>\n        </div>\n        <div class=\"category-text\">{{item.title}}</div>\n      </div>\n\n    </div>\n  </div>\n"},/***** module 44 end *****/


/***** module 45 start *****/
/***** src\theme\components\indexList.wpy *****/
function(module, exports, __wepy_require) {module.exports = "\n  <div class=\"indexlist\">\n    <div class=\"indexlist-name\" v-if=\"(title)\">{{title}}</div>\n    <div v-if=\"(list.length > 0)\">\n      <div v-for=\"(index, item) in (list)\">\n        <a class=\"indexlist-item clearfix\" :url=\"'/pages/main/detail?id=' + (item.id) + '&amp;title=' + (item.title) + '&amp;status=' + (item.status)\">\n          <div class=\"indexlist-cover-wrapper\">\n            <img mode=\"widthFix\" style=\"width:100%;\" :src=\"(item.image)\"/>\n          </div>\n          <div class=\"indexlist-content-wrapper\">\n            <div class=\"indexlist-title\">{{item.title}}</div>\n            <div class=\"indexlist-abstract\">{{item.content}}</div>\n            <div class=\"indexlist-tags\" v-if=\"(isCollectList)\">\n\n              <div v-if=\"(item.status == '1')\">\n                <img class=\"imgicon\" mode=\"aspectFit\" :src=\"(icon_eye_active)\"/>\n                <span class=\"indexlist-text color-blue\">可借阅</span>\n              </div>\n              <div  wx:else=\"wx:else\">\n                <img class=\"imgicon\" mode=\"aspectFit\" :src=\"(icon_eye)\"/>\n                <span class=\"indexlist-text color-bbb\">已借完</span>\n              </div>\n\n              <div @click.stop=\"toStar((item),(index),$event)\" class=\"indexlist-status\">\n                <div v-if=\"(item.collected == 1)\">\n                  <img class=\"imgicon\" mode=\"aspectFit\" :src=\"(icon_star_active)\"/>\n                  <span class=\"indexlist-text reset-text-star color-999\">已收藏</span>\n                </div>\n                <div wx:else=\"wx:else\">\n                  <img class=\"imgicon\" mode=\"aspectFit\" :src=\"(icon_star)\"/>\n                  <span class=\"indexlist-text reset-text-star color-blue\">收藏</span>\n                </div>\n              </div>\n\n            </div>\n            <div wx:else=\"wx:else\" class=\"indexlist-tags\">\n              <div v-for=\"(index, tag) in (item.tags)\">\n                <div class=\"indexlist-tag\">{{tag}}</div>\n              </div>\n              <div class=\"indexlist-status\">\n                <div v-if=\"(item.status == '1')\">\n                  <img class=\"imgicon\" mode=\"aspectFit\" :src=\"(icon_eye_active)\"/>\n                  <span class=\"indexlist-text color-blue\">可借阅</span>\n                </div>\n                <div wx:else=\"wx:else\">\n                  <img class=\"imgicon\" mode=\"aspectFit\" :src=\"(icon_eye)\"/>\n                  <span class=\"indexlist-text color-bbb\">已借完</span>\n                </div>\n              </div>\n            </div>\n          </div>\n        </a>\n      </div>\n      <div v-if=\"(loading)\">\n        <div class=\"weui-loadmore\">\n          <div class=\"weui-loading\"></div>\n          <div class=\"weui-loadmore__tips\">正在加载</div>\n        </div>\n      </div>\n      <div :wx:elif=\"(noMore)\">\n        <div class=\"weui-loadmore weui-loadmore_line weui-loadmore_dot\">\n          <div class=\"weui-loadmore__tips weui-loadmore__tips_in-line weui-loadmore__tips_in-dot\"></div>\n        </div>\n      </div>\n    </div>\n    <div wx:else=\"wx:else\">\n      <div class=\"weui-loadmore weui-loadmore_line\">\n        <div class=\"weui-loadmore__tips weui-loadmore__tips_in-line\">暂无书籍</div>\n      </div>\n    </div>\n  </div>\n"},/***** module 45 end *****/


/***** module 46 start *****/
/***** src\theme\components\checkboxButton.wpy *****/
function(module, exports, __wepy_require) {module.exports = "\n  <div class=\"checkbox-button\">\n    <div class=\"checkbox-title\" v-if=\"(hasTitle)\">{{title}}</div>\n    <checkbox-group @change=\"checkboxChange($event)\" :style=\"'margin-right: ' + (style_gutter_edge)\">\n      <div class=\"checkbox-wrapper\" v-for=\"(index, item) in (list)\" :style=\"'width:' + (style_width) + ';padding-right: ' + (style_gutter) + ';margin-bottom: ' + (style_gutter)\">\n        <checkbox :id=\"(unique) + '-' + (index)\" v-show=\"!('hidden')\" :value=\"(item.value)\" :checked=\"(item.checked)\"></checkbox>\n        <label :for=\"(unique) + '-' + (index)\" :class=\"'checkbox-item' + (item.checked ? '-checked' : '' )\">\n          <span>{{item.name}}</span>\n        </label>\n      </div>\n    </checkbox-group>\n  </div>\n"},/***** module 46 end *****/


/***** module 47 start *****/
/***** src\theme\components\screen.wpy *****/
function(module, exports, __wepy_require) {module.exports = "\n  <div class=\"screen-placeholder clearfix\">\n    <slot name=\"placeholder\"></slot>\n  </div>\n  <div class=\"screen-wrapper\" :style=\"(style_position) + ':0;'\">\n    <slot></slot>\n  </div>\n"},/***** module 47 end *****/


/***** module 48 start *****/
/***** src\theme\components\radioCard.wpy *****/
function(module, exports, __wepy_require) {module.exports = "\n  <div class=\"radio-card\">\n    <radio-group @change=\"radioChange($event)\">\n      <div class=\"radio-wrapper\" v-for=\"(index, item) in (list)\">\n        <radio :id=\"(unique) + '-' + (index)\" v-show=\"!('hidden')\" :value=\"(item[key])\" :checked=\"(item.checked)\"></radio>\n\n        <label :for=\"(unique) + '-' + (index)\" :class=\"'radio-item' + (item.checked ? '-checked' : '' )\">\n          <icon class=\"label-icon\" type=\"success\" size=\"14\" color=\"#049BFF\" v-if=\"(item.checked)\"></icon>\n          <span  wx:else=\"wx:else\" class=\"label-icon icon-circle\" style=\"font-size: 14px;\"></span>\n          <span>{{item.period}}个月</span>\n          <div class=\"pull-right\">\n            <span>每次</span>\n            <span class=\"color-text\">{{item.quantity}}</span>\n            <span>本、可借</span>\n            <span class=\"color-text\">{{item.times}}</span>\n            <span>次</span>\n          </div>\n        </label>\n\n      </div>\n    </radio-group>\n  </div>\n"},/***** module 48 end *****/
...
var _component2 = __wepy_require(51);
...
var _vue = __wepy_require(70);

var _vue2 = _interopRequireDefault(_vue);

var _vueRouter = __wepy_require(71);
...
var _axios = __wepy_require(73);

var _axios2 = _interopRequireDefault(_axios);

var _query = __wepy_require(74);

var _device = __wepy_require(75);
...
/***** module 60 start *****/
/***** src\core\wxService\wxNotice.js *****/
function(module, exports, __wepy_require) {'use strict';
...
var $alert = exports.$alert = {
  ...
  confirm: function confirm(content) {
    ...
    var title = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '询问？';
...
var $notice = exports.$notice = {
  notice: function notice(op) {
  ...
  loadAutoHide: function loadAutoHide() {
    var title = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '加载中';
...
/***** module 61 start *****/
/***** src\core\wxService\wxHttp.js *****/
function(module, exports, __wepy_require) {'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.del = exports.put = exports.post = exports.get = exports.httpNoWait = exports.http = undefined;
...
var __ajax = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(self, op, complete) {
    var funcAjax = function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 1;
                _context.next = 4;
                return _wepy2.default.request(op);

              case 4:
                res = _context.sent;
                return _context.abrupt('return', funcSuccess(res));

              case 8:
                _context.prev = 8;
                _context.t0 = _context['catch'](1);
                return _context.abrupt('return', funcError(_context.t0));
      ...
      return function funcAjax() {
        return _ref2.apply(this, arguments);
      };
    }();

    var funcInit, funcSuccess, funcError, funcFinally;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            funcFinally = function funcFinally(res) {
              if (helpers.isFunction(complete)) {
                complete(res);
              }
              if (self && self.$apply) {
            ...
            funcError = function funcError(err) {
              return Promise.reject(err);
            };

            funcSuccess = function funcSuccess(res) {
            ...
            funcInit();
            return _context2.abrupt('return', funcAjax());
  ...
  return function __ajax(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

var __ajaxList = function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(self, op, complete) {
    var timeOutAjax = function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return _context5.abrupt('return', __ajax(self, op, complete));

          case 7:
            return _context5.abrupt('return', timeOutAjax());
  ...
  return function __ajaxList(_x4, _x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();

var http = exports.http = function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(self, method, api) {
    ...
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            return _context6.abrupt('return', __ajax(self, {
              url: api,
              data: body,
              method: method
            }, complete));
  ...
  return function http(_x9, _x10, _x11) {
    return _ref6.apply(this, arguments);
  };
}();

var httpNoWait = exports.httpNoWait = function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(self, method, api) {
    var body = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
    var complete = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
    return regeneratorRuntime.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            return _context7.abrupt('return', __ajax(self, {
  ...
  return function httpNoWait(_x14, _x15, _x16) {
    return _ref7.apply(this, arguments);
  };
}();

var get = exports.get = function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(self, api) {
    ...
    return regeneratorRuntime.wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            return _context8.abrupt('return', __ajaxList(self, {
              url: config.api.base + '/' + api,
              data: body,
              method: 'GET'
            }, complete));
  ...
  return function get(_x19, _x20) {
    return _ref8.apply(this, arguments);
  };
}();

var post = exports.post = function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(self, api) {
    var body = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    var complete = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
    return regeneratorRuntime.wrap(function _callee9$(_context9) {
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            return _context9.abrupt('return', __ajaxList(self, {
              url: config.api.base + '/' + api,
              data: body,
              method: 'POST'
            }, complete));
  ...
  return function post(_x23, _x24) {
    return _ref9.apply(this, arguments);
  };
}();

var put = exports.put = function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(self, api) {
    var body = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    var complete = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
    return regeneratorRuntime.wrap(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            return _context10.abrupt('return', __ajaxList(self, {
              url: config.api.base + '/' + api,
              data: body,
              method: 'PUT'
            }, complete));
  ...
  return function put(_x27, _x28) {
    return _ref10.apply(this, arguments);
  };
}();

var del = exports.del = function () {
  var _ref11 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(self, api) {
    var body = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    var complete = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
    return regeneratorRuntime.wrap(function _callee11$(_context11) {
      while (1) {
        switch (_context11.prev = _context11.next) {
          case 0:
            return _context11.abrupt('return', __ajaxList(self, {
              url: config.api.base + '/' + api,
              data: body,
              method: 'DELETE'
            }, complete));
...
var _wxStorage = __wepy_require(76);
...
var IndexMixin = function (_wepy$mixin) {
  _inherits(IndexMixin, _wepy$mixin);
  ...
  function IndexMixin() {
    ...
    _classCallCheck(this, IndexMixin);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = IndexMixin.__proto__ || Object.getPrototypeOf(IndexMixin)).call.apply(_ref, [this].concat(args))), _this), _this.data = {
      httpLoading: false
    }, _this.$storage = _wxStorage2.default, _this.$notice = wxNotice.$notice, _this.$alert = wxNotice.$alert, _this.$auth = function () {
      return new _auth2.default(_this);
    }(_this), _this.helpers = function () {
      return helpers;
    }(_this), _this.wxService = WxService, _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(IndexMixin, [{
    key: '$http',
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(method, api) {
        var body = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
        var complete = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt('return', wxHttp.http(this, method, api, body, complete));
      ...
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(api) {
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                return _context2.abrupt('return', wxHttp.get(this, api, body, complete));
      ...
      var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(api) {
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                return _context3.abrupt('return', wxHttp.post(this, api, body, complete));
    ...
    key: '$httpPut',
    value: function () {
      var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(api) {
        var body = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
        var complete = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                return _context4.abrupt('return', wxHttp.put(this, api, body, complete));
      ...
      var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(api) {
        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                return _context5.abrupt('return', wxHttp.del(this, api, body, complete));
...
exports.default = IndexMixin;
},/***** module 63 end *****/


/***** module 64 start *****/
/***** src\core\mixins\case.js *****/
function(module, exports, __wepy_require) {'use strict';
...
var CaseMixin = function (_wepy$mixin) {
  _inherits(CaseMixin, _wepy$mixin);
  ...
  function CaseMixin() {
    ...
    _classCallCheck(this, CaseMixin);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CaseMixin.__proto__ || Object.getPrototypeOf(CaseMixin)).call.apply(_ref, [this].concat(args))), _this), _this.getCartList = cart.getCartList, _this.addCart = cart.addCart, _this.removeCart = cart.removeCart, _temp), _possibleConstructorReturn(_this, _ret);
  }

  return CaseMixin;
}(_wepy2.default.mixin);

exports.default = CaseMixin;
},/***** module 64 end *****/
...
var parentComponent = function (_wepy$component) {
  _inherits(parentComponent, _wepy$component);
  ...
  function parentComponent() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = parentComponent.__proto__ || Object.getPrototypeOf(parentComponent)).call.apply(_ref, [this].concat(args))), _this), _this.mixins = [_index2.default, _case2.default], _temp), _possibleConstructorReturn(_this, _ret);
  }
...
/***** module 67 start *****/
/***** src\theme\components\swiper.wpy *****/
function(module, exports, __wepy_require) {module.exports = "swiper,\n.swiper {\n  width: 100%;\n}\n.swiper-image {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  width: 100%;\n  transform: translate(-50%, -50%);\n}\n\n"},/***** module 67 end *****/


/***** module 68 start *****/
/***** src\theme\components\screen.wpy *****/
function(module, exports, __wepy_require) {module.exports = ".screen-placeholder {\n  opacity: 0;\n  pointer-events: none;\n}\n.screen-wrapper {\n  position: fixed;\n  left: 0;\n  right: 0;\n}\n\n"},/***** module 68 end *****/
...
/***** module 76 start *****/
/***** src\core\wxService\wxStorage.js *****/
function(module, exports, __wepy_require) {"use strict";
...
var wxStorage = {
  ...
  removeSync: function removeSync(k) {
    try {
...
exports.realAddCart = realAddCart;
...
function getCartList(callback) {
  ...
  // 回调提供商品列表
  var list = this.helpers.getArray(this.$parent.globalDataSet('cart'));
  // 优先执行回调
  if (this.helpers.isFunction(callback)) {
    var result = callback(list);
    // 更新返回的列表
    this.helpers.isArray(result) && this.$parent.globalDataSet('cart', result);
  }
  return list;
}
...
function addCart(item, callback) {
  ...
  function userBuild(result) {
    ...
    if (this.helpers.isDefined(packages)) {
      ...
      if (!+times) {
        return this.helpers.isFunction(callback) && callback({
          code: 4001,
          message: '您当前不可借阅图书，请购买订阅套餐'
        });
      }
      // 判断是否已超出
      if (list.length >= +quantity) {
        // 超出提示
        this.helpers.isFunction(callback) && callback({
          code: 1001,
          message: '您的订阅图书的数量已达到上限，请删除某本再借阅'
        });
      } else {
        // 真去加车
        try {
...
// 从购物车移除
function removeCart(item, callback) {
  updateCart({
    arr: item,
    isRemove: true
  }, {
 ...
 * 业务/框架无关
 */
function updateCart(_ref, _ref2) {
  var _this = this;

  var arr = _ref.arr,
      isRemove = _ref.isRemove;
  var getList = _ref2.getList,
      isEqual = _ref2.isEqual;

  // 整理数据
  var itemArr = this.helpers.isArray(arr) ? arr : [arr];
  ...
  itemArr.map(function (good) {
    ...
    _this.helpers.isFunction(getList) && getList.bind(_this)(function (list) {
      // 对比去重
      var existIndex = undefined;
      if (_this.helpers.isFunction(isEqual)) {
      ...
      if (isRemove) {
        // remove只在存在时操作删除
        _this.helpers.isDefined(existIndex) && list.splice(existIndex, 1);
      } else {
        // add: 存在加数量，不存在push
        _this.helpers.isDefined(existIndex) ? list[existIndex].amount++ : list.push(tempData);
      }
      return list;
    });
  });
...
/***** module 78 start *****/
/***** src\pages\main\list.wpy *****/
function(module, exports, __wepy_require) {module.exports = "/**\n* Tencent is pleased to support the open source community by making\n* WeUI-WXSS available.\n* \n* Copyright (C) 2017 THL A29 Limited, a Tencent company.\n* All rights reserved.\n* \n* Licensed under the MIT License (the \"License\"); you may not use\n* this file except in compliance with the License. You may obtain a copy of\n* the License at\n* \n*       http://opensource.org/licenses/MIT\n* \n* Unless required by applicable law or agreed to in writing, software\n* distributed under the License is distributed on an \"AS IS\" BASIS,\n* WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n* See the License for the specific language governing permissions and\n* limitations under the License.\n*/\n/**\n* Tencent is pleased to support the open source community by making\n* WeUI-WXSS available.\n* \n* Copyright (C) 2017 THL A29 Limited, a Tencent company.\n* All rights reserved.\n* \n* Licensed under the MIT License (the \"License\"); you may not use\n* this file except in compliance with the License. You may obtain a copy of\n* the License at\n* \n*       http://opensource.org/licenses/MIT\n* \n* Unless required by applicable law or agreed to in writing, software\n* distributed under the License is distributed on an \"AS IS\" BASIS,\n* WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n* See the License for the specific language governing permissions and\n* limitations under the License.\n*/\n/**\n* Tencent is pleased to support the open source community by making\n* WeUI-WXSS available.\n* \n* Copyright (C) 2017 THL A29 Limited, a Tencent company.\n* All rights reserved.\n* \n* Licensed under the MIT License (the \"License\"); you may not use\n* this file except in compliance with the License. You may obtain a copy of\n* the License at\n* \n*       http://opensource.org/licenses/MIT\n* \n* Unless required by applicable law or agreed to in writing, software\n* distributed under the License is distributed on an \"AS IS\" BASIS,\n* WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n* See the License for the specific language governing permissions and\n* limitations under the License.\n*/\n/**\n* Tencent is pleased to support the open source community by making\n* WeUI-WXSS available.\n* \n* Copyright (C) 2017 THL A29 Limited, a Tencent company.\n* All rights reserved.\n* \n* Licensed under the MIT License (the \"License\"); you may not use\n* this file except in compliance with the License. You may obtain a copy of\n* the License at\n* \n*       http://opensource.org/licenses/MIT\n* \n* Unless required by applicable law or agreed to in writing, software\n* distributed under the License is distributed on an \"AS IS\" BASIS,\n* WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n* See the License for the specific language governing permissions and\n* limitations under the License.\n*/\n/**\n* Tencent is pleased to support the open source community by making\n* WeUI-WXSS available.\n* \n* Copyright (C) 2017 THL A29 Limited, a Tencent company.\n* All rights reserved.\n* \n* Licensed under the MIT License (the \"License\"); you may not use\n* this file except in compliance with the License. You may obtain a copy of\n* the License at\n* \n*       http://opensource.org/licenses/MIT\n* \n* Unless required by applicable law or agreed to in writing, software\n* distributed under the License is distributed on an \"AS IS\" BASIS,\n* WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n* See the License for the specific language governing permissions and\n* limitations under the License.\n*/\n/**\n* Tencent is pleased to support the open source community by making\n* WeUI-WXSS available.\n* \n* Copyright (C) 2017 THL A29 Limited, a Tencent company.\n* All rights reserved.\n* \n* Licensed under the MIT License (the \"License\"); you may not use\n* this file except in compliance with the License. You may obtain a copy of\n* the License at\n* \n*       http://opensource.org/licenses/MIT\n* \n* Unless required by applicable law or agreed to in writing, software\n* distributed under the License is distributed on an \"AS IS\" BASIS,\n* WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n* See the License for the specific language governing permissions and\n* limitations under the License.\n*/\n/**\n* Tencent is pleased to support the open source community by making\n* WeUI-WXSS available.\n* \n* Copyright (C) 2017 THL A29 Limited, a Tencent company.\n* All rights reserved.\n* \n* Licensed under the MIT License (the \"License\"); you may not use\n* this file except in compliance with the License. You may obtain a copy of\n* the License at\n* \n*       http://opensource.org/licenses/MIT\n* \n* Unless required by applicable law or agreed to in writing, software\n* distributed under the License is distributed on an \"AS IS\" BASIS,\n* WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n* See the License for the specific language governing permissions and\n* limitations under the License.\n*/\n/**\n* Tencent is pleased to support the open source community by making\n* WeUI-WXSS available.\n* \n* Copyright (C) 2017 THL A29 Limited, a Tencent company.\n* All rights reserved.\n* \n* Licensed under the MIT License (the \"License\"); you may not use\n* this file except in compliance with the License. You may obtain a copy of\n* the License at\n* \n*       http://opensource.org/licenses/MIT\n* \n* Unless required by applicable law or agreed to in writing, software\n* distributed under the License is distributed on an \"AS IS\" BASIS,\n* WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n* See the License for the specific language governing permissions and\n* limitations under the License.\n*/\n/**\n* Tencent is pleased to support the open source community by making\n* WeUI-WXSS available.\n* \n* Copyright (C) 2017 THL A29 Limited, a Tencent company.\n* All rights reserved.\n* \n* Licensed under the MIT License (the \"License\"); you may not use\n* this file except in compliance with the License. You may obtain a copy of\n* the License at\n* \n*       http://opensource.org/licenses/MIT\n* \n* Unless required by applicable law or agreed to in writing, software\n* distributed under the License is distributed on an \"AS IS\" BASIS,\n* WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n* See the License for the specific language governing permissions and\n* limitations under the License.\n*/\n/**\n* Tencent is pleased to support the open source community by making\n* WeUI-WXSS available.\n* \n* Copyright (C) 2017 THL A29 Limited, a Tencent company.\n* All rights reserved.\n* \n* Licensed under the MIT License (the \"License\"); you may not use\n* this file except in compliance with the License. You may obtain a copy of\n* the License at\n* \n*       http://opensource.org/licenses/MIT\n* \n* Unless required by applicable law or agreed to in writing, software\n* distributed under the License is distributed on an \"AS IS\" BASIS,\n* WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n* See the License for the specific language governing permissions and\n* limitations under the License.\n*/\n/**\n* Tencent is pleased to support the open source community by making\n* WeUI-WXSS available.\n* \n* Copyright (C) 2017 THL A29 Limited, a Tencent company.\n* All rights reserved.\n* \n* Licensed under the MIT License (the \"License\"); you may not use\n* this file except in compliance with the License. You may obtain a copy of\n* the License at\n* \n*       http://opensource.org/licenses/MIT\n* \n* Unless required by applicable law or agreed to in writing, software\n* distributed under the License is distributed on an \"AS IS\" BASIS,\n* WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n* See the License for the specific language governing permissions and\n* limitations under the License.\n*/\n/**\n* Tencent is pleased to support the open source community by making\n* WeUI-WXSS available.\n* \n* Copyright (C) 2017 THL A29 Limited, a Tencent company.\n* All rights reserved.\n* \n* Licensed under the MIT License (the \"License\"); you may not use\n* this file except in compliance with the License. You may obtain a copy of\n* the License at\n* \n*       http://opensource.org/licenses/MIT\n* \n* Unless required by applicable law or agreed to in writing, software\n* distributed under the License is distributed on an \"AS IS\" BASIS,\n* WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n* See the License for the specific language governing permissions and\n* limitations under the License.\n*/\n.main-list .width-8p {\n  width: 80% !important;\n}\n.main-list .main-list-title {\n  padding: 1em 15px;\n  color: #999999;\n  font-size: 14px;\n}\n\n"},/***** module 78 end *****/


/***** module 79 start *****/
/***** src\pages\borrow\index.wpy *****/
function(module, exports, __wepy_require) {module.exports = ".page-borrow .borrow-list .weui-media-box_text {\n  font-size: 14px !important;\n  padding-right: 5em;\n  line-height: 1;\n  vertical-align: middle;\n}\n.page-borrow .borrow-address .weui-textarea {\n  width: 300px;\n}\n.page-borrow .borrow-address .weui-media-box {\n  padding-bottom: 1em;\n}\n.page-borrow .borrow-address .weui-media-box__title {\n  padding-bottom: 0.5em;\n}\n.page-borrow .borrow-address .reset-pull-right {\n  font-size: 14px !important;\n  top: 15px;\n  bottom: auto;\n  margin-top: -0.5em;\n}\n.page-borrow .borrow-address .reset-pull-middle {\n  top: 1em;\n}\n.page-borrow .borrow-address .icon-location {\n  width: 1.5em;\n  height: 1.5em;\n}\n.page-borrow .borrow-name-wrapper {\n  display: inline-block;\n  position: absolute;\n  top: 0;\n  left: 15px;\n  right: 15px;\n  bottom: 0;\n  height: 1em;\n  padding-left: 24.5px;\n  padding-right: 4em;\n  line-height: 1;\n  margin: auto;\n}\n.page-borrow .borrow-book-name {\n  width: 100%;\n  display: block;\n  overflow: hidden;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n}\n.page-borrow .reset-pull-right,\n.page-borrow .reset-pull-middle {\n  position: absolute;\n  right: 15px;\n  top: 0;\n  bottom: 0;\n  height: 2em;\n  line-height: 2;\n  padding: 0 1em;\n  margin: auto -1em auto 0;\n}\n.page-borrow .reset-label-left {\n  color: #999;\n  margin-right: 1em;\n  padding-right: 1em;\n  border-right: 0.5px solid #EFEFEF;\n}\n.page-borrow .icon-order-circle,\n.page-borrow .icon-order-empty {\n  display: inline-block;\n  width: 17px;\n  height: 17px;\n  font-size: 90%;\n  line-height: 17px;\n  border: 0.5px solid transparent;\n  border-radius: 50%;\n  text-align: center;\n}\n.page-borrow .icon-order-circle {\n  color: #fff;\n  background: #049BFF;\n  border-color: #049BFF;\n}\n.page-borrow .icon-order-empty {\n  color: #ddd;\n  background: transparent;\n  border-color: #ddd;\n}\n.page-borrow .icon-delete {\n  display: inline-block;\n  width: 17px;\n  height: 17px;\n}\n.page-borrow .icon-delete:before,\n.page-borrow .icon-delete:after {\n  content: '';\n  display: inline-block;\n  position: absolute;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  width: 1px;\n  height: 100%;\n  margin: auto;\n  background: #999;\n  transform: rotate(45deg);\n}\n.page-borrow .icon-delete:after {\n  transform: rotate(-45deg);\n}\n.page-borrow-tip .tip-icon {\n  margin-top: 20vh;\n}\n\n"},/***** module 79 end *****/


/***** module 80 start *****/
/***** src\pages\main\detail.wpy *****/
function(module, exports, __wepy_require) {module.exports = ".main-detail .detail-cover {\n  display: block;\n  margin: 20px auto 0;\n}\n.main-detail .detail-tags {\n  font-size: 14px !important;\n  padding: 0.4em 0;\n}\n.main-detail .detail-desc-title {\n  font-size: 14px !important;\n  color: #ccc;\n}\n.main-detail .detail-info,\n.main-detail .detail-desc {\n  color: #aaa;\n  font-size: 12px;\n  line-height: 1;\n  padding: 0.5em 0;\n  overflow: hidden;\n  text-align: center;\n}\n.main-detail .detail-info,\n.main-detail .detail-text {\n  text-align: left;\n  line-height: 1.5;\n}\n.main-detail .detail-text + .detail-image {\n  margin-top: 0.5em;\n}\n.main-detail .detail-image {\n  width: 100%;\n}\n.main-detail .detail-image + .detail-text {\n  margin-top: 0.5em;\n}\n.main-detail .btn-flex-1 {\n  padding: 0;\n  width: 3.5em;\n  line-height: 1.6;\n  overflow: hidden;\n}\n.main-detail .btn-flex-full {\n  flex: 1 1 auto;\n}\n.main-detail .btn-text-bottom {\n  font-size: 12px !important;\n  line-height: 1;\n  color: #777;\n}\n\n"},/***** module 80 end *****/


/***** module 81 start *****/
/***** src\pages\borrow\subscribe.wpy *****/
function(module, exports, __wepy_require) {module.exports = ".borrow-subscribe .weui-media-box__title {\n  padding-bottom: 0.5em;\n}\n.borrow-subscribe .borrow-address {\n  margin-bottom: 1em;\n}\n.borrow-subscribe .reset-cell-block {\n  display: block !important;\n  padding-bottom: 0;\n}\n.borrow-subscribe .reset-cell-block + .weui-cell:before {\n  display: none;\n}\n.borrow-subscribe .reset-label-left {\n  color: #999;\n  margin-right: 1em;\n  padding-right: 1em;\n  border-right: 0.5px solid #EFEFEF;\n}\n.borrow-subscribe .reset-label-right {\n  color: #666;\n  line-height: 0;\n  margin-left: 1em;\n  padding-left: 1em;\n}\n.borrow-subscribe .reset-input {\n  padding: 6px 15px;\n}\n\n"},/***** module 81 end *****/
...
/***** module 83 start *****/
/***** src\pages\user\index.wpy *****/
function(module, exports, __wepy_require) {module.exports = ".page-user .userinfo {\n  padding: 10px 0;\n}\n.page-user .userinfo-avatar {\n  float: left;\n  width: 50px;\n  height: 50px;\n  border-radius: 50%;\n}\n.page-user .userinfo-info {\n  float: left;\n  line-height: 1;\n  padding: 4px 0;\n  margin-left: 12px;\n}\n.page-user .userinfo-nickname {\n  color: #5cbaa7;\n  font-size: 18.133333335px;\n  margin-bottom: 8px;\n}\n.page-user .userinfo-status {\n  color: #999;\n  font-size: 15.866666665px;\n}\n\n"},/***** module 83 end *****/


/***** module 84 start *****/
/***** src\pages\user\borrow.wpy *****/
function(module, exports, __wepy_require) {module.exports = ".user-borrow .weui-loadmore__tips_in-line {\n  background: transparent;\n}\n.user-borrow .weui-media-box_appmsg {\n  align-items: flex-start;\n  margin-bottom: 20px;\n}\n.user-borrow .weui-media-box__desc {\n  font-size: 14px !important;\n  display: block;\n  overflow: hidden;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n  line-height: 1.6;\n}\n.user-borrow .weui-media-box__hd_in-appmsg {\n  position: relative;\n  width: 40px;\n  height: 53.333333335px;\n  margin-right: 40px;\n}\n.user-borrow .weui-media-box__thumb {\n  position: absolute;\n  top: 0;\n  left: 0;\n  background: #fff;\n  border: 2.5px solid #fff;\n  box-shadow: -1.5px 1.5px 2.5px 0 rgba(0, 0, 0, 0.3);\n}\n.user-borrow .weui-media-box__thumb:last-child {\n  box-shadow: -0.5px 1.5px 2.5px 1px rgba(0, 0, 0, 0.4);\n}\n.user-borrow .weui-media-box__thumb:nth-child(5) {\n  top: 0;\n  left: 25px;\n}\n.user-borrow .weui-media-box__thumb:nth-child(4) {\n  top: 0;\n  left: 20px;\n}\n.user-borrow .weui-media-box__thumb:nth-child(3) {\n  top: 0;\n  left: 15px;\n}\n.user-borrow .weui-media-box__thumb:nth-child(2) {\n  top: 0;\n  left: 10px;\n}\n.user-borrow .weui-media-box__thumb:nth-child(1) {\n  top: 0;\n  left: 5px;\n}\n\n"},/***** module 84 end *****/
...
/***** module 86 start *****/
/***** src\pages\user\subscribe.wpy *****/
function(module, exports, __wepy_require) {module.exports = "/**\n* Tencent is pleased to support the open source community by making\n* WeUI-WXSS available.\n* \n* Copyright (C) 2017 THL A29 Limited, a Tencent company.\n* All rights reserved.\n* \n* Licensed under the MIT License (the \"License\"); you may not use\n* this file except in compliance with the License. You may obtain a copy of\n* the License at\n* \n*       http://opensource.org/licenses/MIT\n* \n* Unless required by applicable law or agreed to in writing, software\n* distributed under the License is distributed on an \"AS IS\" BASIS,\n* WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n* See the License for the specific language governing permissions and\n* limitations under the License.\n*/\n/**\n* Tencent is pleased to support the open source community by making\n* WeUI-WXSS available.\n* \n* Copyright (C) 2017 THL A29 Limited, a Tencent company.\n* All rights reserved.\n* \n* Licensed under the MIT License (the \"License\"); you may not use\n* this file except in compliance with the License. You may obtain a copy of\n* the License at\n* \n*       http://opensource.org/licenses/MIT\n* \n* Unless required by applicable law or agreed to in writing, software\n* distributed under the License is distributed on an \"AS IS\" BASIS,\n* WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n* See the License for the specific language governing permissions and\n* limitations under the License.\n*/\n/**\n* Tencent is pleased to support the open source community by making\n* WeUI-WXSS available.\n* \n* Copyright (C) 2017 THL A29 Limited, a Tencent company.\n* All rights reserved.\n* \n* Licensed under the MIT License (the \"License\"); you may not use\n* this file except in compliance with the License. You may obtain a copy of\n* the License at\n* \n*       http://opensource.org/licenses/MIT\n* \n* Unless required by applicable law or agreed to in writing, software\n* distributed under the License is distributed on an \"AS IS\" BASIS,\n* WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n* See the License for the specific language governing permissions and\n* limitations under the License.\n*/\n/**\n* Tencent is pleased to support the open source community by making\n* WeUI-WXSS available.\n* \n* Copyright (C) 2017 THL A29 Limited, a Tencent company.\n* All rights reserved.\n* \n* Licensed under the MIT License (the \"License\"); you may not use\n* this file except in compliance with the License. You may obtain a copy of\n* the License at\n* \n*       http://opensource.org/licenses/MIT\n* \n* Unless required by applicable law or agreed to in writing, software\n* distributed under the License is distributed on an \"AS IS\" BASIS,\n* WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n* See the License for the specific language governing permissions and\n* limitations under the License.\n*/\n/**\n* Tencent is pleased to support the open source community by making\n* WeUI-WXSS available.\n* \n* Copyright (C) 2017 THL A29 Limited, a Tencent company.\n* All rights reserved.\n* \n* Licensed under the MIT License (the \"License\"); you may not use\n* this file except in compliance with the License. You may obtain a copy of\n* the License at\n* \n*       http://opensource.org/licenses/MIT\n* \n* Unless required by applicable law or agreed to in writing, software\n* distributed under the License is distributed on an \"AS IS\" BASIS,\n* WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n* See the License for the specific language governing permissions and\n* limitations under the License.\n*/\n/**\n* Tencent is pleased to support the open source community by making\n* WeUI-WXSS available.\n* \n* Copyright (C) 2017 THL A29 Limited, a Tencent company.\n* All rights reserved.\n* \n* Licensed under the MIT License (the \"License\"); you may not use\n* this file except in compliance with the License. You may obtain a copy of\n* the License at\n* \n*       http://opensource.org/licenses/MIT\n* \n* Unless required by applicable law or agreed to in writing, software\n* distributed under the License is distributed on an \"AS IS\" BASIS,\n* WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n* See the License for the specific language governing permissions and\n* limitations under the License.\n*/\n/**\n* Tencent is pleased to support the open source community by making\n* WeUI-WXSS available.\n* \n* Copyright (C) 2017 THL A29 Limited, a Tencent company.\n* All rights reserved.\n* \n* Licensed under the MIT License (the \"License\"); you may not use\n* this file except in compliance with the License. You may obtain a copy of\n* the License at\n* \n*       http://opensource.org/licenses/MIT\n* \n* Unless required by applicable law or agreed to in writing, software\n* distributed under the License is distributed on an \"AS IS\" BASIS,\n* WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n* See the License for the specific language governing permissions and\n* limitations under the License.\n*/\n/**\n* Tencent is pleased to support the open source community by making\n* WeUI-WXSS available.\n* \n* Copyright (C) 2017 THL A29 Limited, a Tencent company.\n* All rights reserved.\n* \n* Licensed under the MIT License (the \"License\"); you may not use\n* this file except in compliance with the License. You may obtain a copy of\n* the License at\n* \n*       http://opensource.org/licenses/MIT\n* \n* Unless required by applicable law or agreed to in writing, software\n* distributed under the License is distributed on an \"AS IS\" BASIS,\n* WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n* See the License for the specific language governing permissions and\n* limitations under the License.\n*/\n/**\n* Tencent is pleased to support the open source community by making\n* WeUI-WXSS available.\n* \n* Copyright (C) 2017 THL A29 Limited, a Tencent company.\n* All rights reserved.\n* \n* Licensed under the MIT License (the \"License\"); you may not use\n* this file except in compliance with the License. You may obtain a copy of\n* the License at\n* \n*       http://opensource.org/licenses/MIT\n* \n* Unless required by applicable law or agreed to in writing, software\n* distributed under the License is distributed on an \"AS IS\" BASIS,\n* WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n* See the License for the specific language governing permissions and\n* limitations under the License.\n*/\n/**\n* Tencent is pleased to support the open source community by making\n* WeUI-WXSS available.\n* \n* Copyright (C) 2017 THL A29 Limited, a Tencent company.\n* All rights reserved.\n* \n* Licensed under the MIT License (the \"License\"); you may not use\n* this file except in compliance with the License. You may obtain a copy of\n* the License at\n* \n*       http://opensource.org/licenses/MIT\n* \n* Unless required by applicable law or agreed to in writing, software\n* distributed under the License is distributed on an \"AS IS\" BASIS,\n* WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n* See the License for the specific language governing permissions and\n* limitations under the License.\n*/\n/**\n* Tencent is pleased to support the open source community by making\n* WeUI-WXSS available.\n* \n* Copyright (C) 2017 THL A29 Limited, a Tencent company.\n* All rights reserved.\n* \n* Licensed under the MIT License (the \"License\"); you may not use\n* this file except in compliance with the License. You may obtain a copy of\n* the License at\n* \n*       http://opensource.org/licenses/MIT\n* \n* Unless required by applicable law or agreed to in writing, software\n* distributed under the License is distributed on an \"AS IS\" BASIS,\n* WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n* See the License for the specific language governing permissions and\n* limitations under the License.\n*/\n/**\n* Tencent is pleased to support the open source community by making\n* WeUI-WXSS available.\n* \n* Copyright (C) 2017 THL A29 Limited, a Tencent company.\n* All rights reserved.\n* \n* Licensed under the MIT License (the \"License\"); you may not use\n* this file except in compliance with the License. You may obtain a copy of\n* the License at\n* \n*       http://opensource.org/licenses/MIT\n* \n* Unless required by applicable law or agreed to in writing, software\n* distributed under the License is distributed on an \"AS IS\" BASIS,\n* WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n* See the License for the specific language governing permissions and\n* limitations under the License.\n*/\n.user-subscribe {\n  text-align: center;\n  background: #fff;\n}\n.user-subscribe .subscribe-title {\n  font-size: 14px !important;\n  text-align: left;\n  color: #666;\n  padding: 10px 20px 5px;\n}\n.user-subscribe .subscribe-wrapper {\n  padding: 10px 0;\n}\n.user-subscribe .subscribe-item {\n  position: relative;\n}\n.user-subscribe .subscribe-item:before {\n  content: \" \";\n  position: absolute;\n  left: 0;\n  top: 0;\n  width: 1px;\n  bottom: 0;\n  border-left: 0.5px solid #D9D9D9;\n  color: #D9D9D9;\n}\n.user-subscribe .subscribe-item:first-child:before {\n  display: none;\n}\n.user-subscribe .item-title {\n  font-size: 16px !important;\n  line-height: 1;\n}\n.user-subscribe .mini-btn {\n  margin: 1em auto;\n}\n\n"},/***** module 86 end *****/
